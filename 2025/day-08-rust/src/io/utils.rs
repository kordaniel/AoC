...
pub fn handle_args_load_puzzle_input() -> Option<(Vec<String>, bool)> {
    ...
    if parsed_args.render_help {
        println!("Rust implementation of the solutions to the Advent of Code, day 8 challenges.");
    ...
    match parsed_args.input_data {
        InputDataSelection::FilePath(filepath) => {
            ...
            Some((read_input_file(&filepath), true))
        },
